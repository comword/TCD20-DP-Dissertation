...
\newcommand{\thesistitle}{A mobile exam proctoring system with deep-learning-based human activity recognition} % Your thesis title, this is used in the title and abstract
...
\input{implementation/implementation} % 8 pages
