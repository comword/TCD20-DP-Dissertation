...
\input{design/design} % 9 pages / 35
\input{implementation/implementation} % 8 pages / 43
\input{evaluation/evaluation} % 8 pages / 51
\input{conclusion/conclusion} % 2 pages / 53
\newpage
\nocite{*}
