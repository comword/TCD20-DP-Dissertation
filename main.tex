...
\mainmatter
% \onehalfspacing
\input{introduction/introduction} % 5 pages
\input{literature/literature} % 15 pages
\input{design/design} % 8 pages
...
% \bibliography{bibs/background, bibs/prevResearch, bibs/deepModel, bibs/mobileOptimus, bibs/impletEval, bibs/misc}
\printbibliography
% }
\appendix
