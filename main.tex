...
\newcommand{\degree}{Master of Science in Computer Science \texorpdfstring{\\} (Future Networked Systems)} % Your degree name, this is used in the title page and abstract
